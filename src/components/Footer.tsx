...
const Footer = () => {
  ...
  const socialLinks = [
    { name: "Facebook", icon: Facebook, href: "#", color: "text-[#1877F2]", bgColor: "bg-[#1877F2]/10" },
    { name: "Twitter", icon: Twitter, href: "#", color: "text-[#1DA1F2]", bgColor: "bg-[#1DA1F2]/10" },
    { name: "LinkedIn", icon: Linkedin, href: "#", color: "text-[#0A66C2]", bgColor: "bg-[#0A66C2]/10" },
    { name: "Instagram", icon: Instagram, href: "#", color: "text-[#E4405F]", bgColor: "bg-[#E4405F]/10" },
  ];
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <MapPin className="h-5 w-5 text-indigo-400 mt-0.5 flex-shrink-0" aria-hidden="true" />
                <div>
                  <p className="text-gray-300 font-medium">Alumni Association Midnapur</p>
              ...
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-indigo-400 flex-shrink-0" aria-hidden="true" />
                <a 
              ...
              <div className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-indigo-400 flex-shrink-0" aria-hidden="true" />
                <a 
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6">
        <div className="text-center">
          <p className="text-xs text-gray-400">
            © 2024 Alumni Association Midnapur. All rights reserved.
          </p>
